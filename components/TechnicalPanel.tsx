...
const RoadmapCard: React.FC<{ title: string; desc: string }> = ({ title, desc }) => (
  <div className="p-3 bg-white dark:bg-neutral-950 border border-green-500/20 rounded-none relative overflow-hidden">
    ...
    <h5 className="font-bold text-neutral-700 dark:text-neutral-350 mb-1">{title}</h5>
