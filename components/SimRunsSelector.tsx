    ...
    return (
      <div className="flex items-center gap-1 w-full sm:w-auto">
        ...
        <button
          ...
          className="text-neutral-400 hover:text-red-400 text-xs px-2 py-2 transition-colors flex-shrink-0"
  ...
  return (
    <div className="flex items-center gap-1 w-full sm:w-auto">
      ...
      <button
        ...
        className="text-[10px] text-violet-400 hover:text-violet-300 border border-violet-500/30 hover:border-violet-400 px-2 py-2.5 transition-colors font-bold flex-shrink-0"
